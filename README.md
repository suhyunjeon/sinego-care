...
이 프로젝트는 커뮤니티용 케어 보조 도구입니다. 질병 진단, 처방, 수액량 결정, 인슐린 조절, 치료식 선택은 반드시 담당 수의사 지시를 우선해야 합니다. 실서비스에서는 PostgreSQL 저장, 승인 기반 가입, 관리자 자료 승인 기능을 사용하며, 개인정보 보호와 백업 정책은 운영 과정에서 계속 보강해야 합니다.
